    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-primary">
                   ...
                   <center><h2 class="page-header text-primary"> BE THE REASON FOR SOMEONE'S HEART BEAT<h2></center>
            </div>
            		 <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Donor_reg.php" class="btn btn-primary">Donate</a>
                    </div>
                </div>
            </div>
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="request_blood.php" class="btn btn-primary">Ask Blood</a>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img class="img-responsive" src="images/cont.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
